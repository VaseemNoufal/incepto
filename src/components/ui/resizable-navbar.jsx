import inceptosvg from '../../assets/inceptobgremovedds.svg'
"use client";;
...
export const Navbar = ({
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-2 z-40 w-full px-10", className)}>
    ...
    <motion.div
      ...
      {items.map((item, idx) => (
        <a
          ...
          <span className="relative z-20 text-black text-base">{item.name}</span>
        </a>
      ))}
    </motion.div>
  );
